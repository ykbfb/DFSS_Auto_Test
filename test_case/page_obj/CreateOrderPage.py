...
class NewOrderPage(Page):
    ...
    def inputOrderDetail_CMP(self):
        ...
        self.switchWindow()
        self.switchToOneFrame2(self.new_order_frame_loc)
        self.getDropdownMenu3(self.sel_contract_loc,1)
        self.getDropdownMenu3(self.sel_service_loc,1)
        ...
        self.getDropdownMenu3(self.year_income_loc,6)
        self.getDropdownMenu3(self.loan_useFor_loc,7)
        self.getDropdownMenu3(self.paybackSource_loc,1)
    ...
    def inputOrderDetail_Personal(self):
        ...
        self.getDropdownMenu3(self.loan_useFor_loc,7)
        self.getDropdownMenu3(self.paybackSource_loc,1)
        self.getDropdownMenu3(self.person_cridit_loc,1)
        self.inputProductDetail()
    ...
    def inputProductDetail(self):
        ...
        self.getDropdownMenu3(self.repayWay_loc,1)
